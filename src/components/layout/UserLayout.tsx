    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-950 dark:to-gray-800">
      ...
      >
        <div className="flex flex-col h-full">
          {/* Header with close button for mobile and collapse toggle */}
          <div className="flex items-center justify-between p-6 border-b border-gray-100 dark:border-gray-800">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="hidden lg:flex p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300"
              >
                {sidebarCollapsed ? (
          ...
          <div className="flex items-center justify-between p-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                size="sm"
                onClick={toggleTheme}
                className="border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-2xl p-3 transition-all duration-300 hover:scale-105"
              >
                {theme === "dark" ? (
